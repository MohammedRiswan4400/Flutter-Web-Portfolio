            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  subHeader('Senior Flutter Developer', getFondSize(false)),
                  SizedBox(height: kHeight * 0.01),
                  subHeader('IoT & Bluetooth Specialist', getFondSize(false)),
                  SizedBox(height: kHeight * 0.01),
                  subHeader('SaaS Architect', getFondSize(false)),
                  SizedBox(height: kHeight * 0.01),
                  subHeader('White-Label Solution Expert', getFondSize(false)),
                  // SizedBox(height: kHeight * 0.01),
